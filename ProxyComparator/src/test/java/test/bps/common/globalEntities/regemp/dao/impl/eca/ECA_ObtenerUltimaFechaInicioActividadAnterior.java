...
public class ECA_ObtenerUltimaFechaInicioActividadAnterior extends AbstractTest {

	//4 ecas y 4 fechas
	static Integer[][] todosLosIds = {{12345, 0, 1}, {123456, 0, 1}, {1234, 0, 1}, {99, 99, 3}};
	static Fecha[] fechas = {new Fecha(1980, 1, 1), null, new Fecha(2000, 5, 5), new Fecha()}; 
	...
	protected Serializable getLlamadaEspecifica() {
		...
		for (int j = 0; j < todosLosIds.length; j++) {
			...
			try {
				...
				obj = daoimpl.obtenerUltimaFechaInicioActividadAnterior(eca, fechas[j]);
